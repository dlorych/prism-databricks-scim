       ...
       //Callback function for getting the user mail id from the prism UI
        ...
        if (checkExists>=1) {
            ...
            for (Object service_principal_id : list) {
                log.info("Service Principal ID for the Service Principal " + service_principal_id);
